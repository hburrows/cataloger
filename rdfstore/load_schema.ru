...
INSERT DATA {
  ...
  common:common:displayOrder rdf:type owl:DatatypeProperty .
  common:common:displayOrder rdfs:domain owl:DatatypeProperty .
  common:common:displayOrder rdfs:range xsd:integer .
