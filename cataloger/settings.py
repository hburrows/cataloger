...
DATABASES = {
    'default': {
        ...
        'NAME': 'cit',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(PROJECT_DIR, 'staticout')
...
SECRET_KEY = 'nmi*j@==ljij8!66#&38lcq8i!2b@wgf(l4^*xjz-!42c==217'
...
#SPARQL_ENDPOINT = 'http://' + SERVER_ENDPOINT + ':3030/cit_tdb/' 
